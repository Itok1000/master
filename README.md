...
|<p align="left">ユーザーがこのサービスをログインなしでいくつかの質問を診断することができます。
<p align="left">この診断は、YESNO方式を用いて、ユーザーの好み、ユーザーの状況に基づいて診断結果を表示します。|
...
|<p align="left">また、Xでのシェア機能を用いて、多くの人に共有できます
